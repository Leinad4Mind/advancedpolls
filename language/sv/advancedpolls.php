...
// Viewtopic
	...
	'AP_SCORE_POINTS_TOTAL'       => [1 => '%d poäng', 2 => '%d poäng'],
	'AP_SCORE_BREAKDOWN'          => 'Röstfördelning',
	'AP_SCORE_AVERAGE'            => 'Genomsnitt: %1$s / %2$d',
	'AP_SCORE_RATINGS'            => [1 => '%d betyg', 2 => '%d betyg'],
	'AP_SCORE_OVERALL_AVERAGE'    => 'Totalt genomsnitt',
	...
	'AP_POLL_LIST'         => 'Omröstningar',
	'AP_POLL_MANAGE_SELECT'     => 'Välj omröstning',
	'AP_POLL_MANAGE_SELECT_ALL' => 'Välj alla',
	'AP_POLL_MANAGE_CLOSE'      => 'Stäng',
	'AP_POLL_MANAGE_OPEN'       => 'Öppna',
	'AP_POLL_LIST_ALL'     => 'Alla omröstningar',
	'AP_POLL_LIST_OPEN'    => 'Öppna',
	'AP_POLL_LIST_CLOSED'  => 'Stängda',
	'AP_POLL_LIST_EMPTY'   => 'Inga tillgängliga omröstningar hittades.',
	'AP_POLL_LIST_VIEW'    => 'Visa omröstning',
	'AP_POLL_LIST_ENDS'    => 'Slutar %s',
	'AP_POLL_LIST_ENDED'   => 'Slutade %s',
	'AP_POLL_LIST_LEADING' => 'Ledande resultat: %1$s - %2$s',
	'AP_POLL_LIST_WINNER'  => 'Vinnare: %1$s - %2$s',
// Posting
	...
	'AP_SCORE_RESULT'              => 'Poängresultat',
	'AP_SCORE_RESULT_EXPLAIN'      => 'Visar antingen samlade poäng eller det aritmetiska medelvärdet av betygen för varje alternativ.',
	'AP_SCORE_RESULT_TOTAL'        => 'Samlade poäng',
	'AP_SCORE_RESULT_AVERAGE'      => 'Genomsnittligt betyg',
	'AP_POLL_SHOW_PERCENT'         => 'Visa procent',
	'AP_POLL_SHOW_PERCENT_EXPLAIN' => 'Visar procenttalet bredvid varje resultatstapel. I genomsnittsläget skalas stapeln alltid mot det högsta betyget.',
	...
	'AP_POLL_COLLAPSIBLE'          => 'Hopfällbar omröstning',
	'AP_POLL_COLLAPSIBLE_EXPLAIN'  => 'Tillåt användare att fälla ihop och fälla ut denna omröstning.',
	'AP_COLLAPSE_POLL'             => 'Fäll ihop omröstningen',
	'AP_EXPAND_POLL'               => 'Fäll ut omröstningen',
	'AP_RUN_POLL'                  => 'Kör omröstningen',
	'AP_RUN_POLL_FOR'              => 'i',
	'AP_RUN_POLL_UNTIL'            => 'till',
	'AP_RUN_POLL_INDEFINITELY'     => 'utan slutdatum',
	'AP_POLL_START'                => 'Omröstningens start',
	'AP_POLL_START_EXPLAIN'        => 'Lämna tomt för att göra omröstningen tillgänglig direkt. Fram till detta datum och klockslag är ämnet synligt, men omröstningen är dold.',
	'AP_POLL_START_INVALID'        => 'Omröstningens start måste vara ett giltigt datum och klockslag i framtiden',
	...
	'AP_POLL_VALUES_INVALID'               => 'Lägsta poäng får inte överstiga högsta poäng; högsta antal alternativ, högsta poäng och totalpoäng måste vara större än noll.',
	...
	'AP_QUESTION'                          => 'Fråga',
	'AP_QUESTION_REQUIRED'                 => 'Obligatorisk fråga',
	'AP_PRIMARY_QUESTION_REQUIRED_EXPLAIN' => 'Kräver ett svar på den första frågan innan hela röstsedeln kan skickas.',
	'AP_APPEND_OPTIONS'                    => 'Lägg till alternativ utan att nollställa röster',
	'AP_APPEND_OPTIONS_EXPLAIN'            => 'Behåller alla befintliga röster och lägger endast till nya alternativ sist i en frågas alternativlista.',
	'AP_APPEND_OPTIONS_WARNING'            => 'Befintliga frågor och alternativ får inte byta namn, tas bort eller ordnas om. Ändring av röst måste vara tillåten. Behöriga registrerade användare som redan har röstat aviseras enligt ACP-inställningen och sina aviseringsinställningar.',
	'AP_APPEND_INVALID'                    => 'Det går inte att lägga till alternativ i den här omröstningen på ett säkert sätt.',
	'AP_APPEND_REQUIRES_CHANGES'           => 'Tillåt ändring av röst innan alternativ läggs till utan att befintliga röster nollställs.',
	'AP_APPEND_POLL_ENDED'                 => 'Det går inte att lägga till alternativ utan att nollställa röster efter att omröstningen har avslutats.',
	'AP_APPEND_STRUCTURE_CHANGED'          => 'Befintliga frågor eller alternativ har ändrats. Återställ den ursprungliga definitionen och lägg endast till nya alternativ sist.',
	'AP_APPEND_TOO_MANY'                   => 'De tillagda alternativen överskrider det inställda högsta antalet omröstningsalternativ.',
	'AP_APPEND_NONE'                       => 'Inga nya omröstningsalternativ har lagts till.',
	'AP_ADDITIONAL_QUESTIONS'              => 'Ytterligare frågesidor',
	'AP_ADDITIONAL_QUESTIONS_EXPLAIN'      => 'Varje sida använder samma omröstningstyp och samma regler för gränser, poäng, synlighet och ändring av röster. Ange ett alternativ per rad.',
	'AP_ADD_QUESTION'                      => 'Lägg till fråga',
	'AP_MULTI_INVALID'                     => 'Uppgifterna för de ytterligare frågorna är ogiltiga.',
	'AP_MULTI_TOO_MANY'                    => 'En omröstning får innehålla högst 20 ytterligare frågor.',
	'AP_MULTI_CONTENT_INVALID'             => 'Varje ytterligare fråga behöver en rubrik och tillräckligt många giltiga alternativ för omröstningens globala gränser.',
	'AP_REQUIRED_QUESTION_MISSING'         => 'Besvara den här obligatoriska frågan innan du fortsätter.',
	'AP_POLL_NAVIGATION'                   => 'Navigering mellan omröstningsfrågor',
	'AP_POLL_MIN_VALUE'                    => 'Minimipoäng',
	'AP_POLL_MIN_VALUE_EXPLAIN'            => 'Detta är den lägsta poäng som en röstande får tilldela ett valt alternativ.',
	'AP_VOTE_OUTSIDE_RANGE'                => 'Varje tilldelad poäng måste ligga mellan de inställda minimi- och maximivärdena.',
]);
