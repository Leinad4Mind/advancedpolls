...
// Viewtopic
	...
	'AP_SCORE_POINTS_TOTAL' => [1 => '%d point', 2 => '%d points'],
	'AP_SCORE_BREAKDOWN' => 'Répartition des votes',
	'AP_SCORE_AVERAGE' => 'Moyenne : %1$s / %2$d',
	'AP_SCORE_RATINGS' => [1 => '%d évaluation', 2 => '%d évaluations'],
	'AP_SCORE_OVERALL_AVERAGE' => 'Moyenne générale',
	...
	'AP_POLL_LIST' => 'Sondages',
	'AP_POLL_MANAGE_SELECT' => 'Sélectionner le sondage',
	'AP_POLL_MANAGE_SELECT_ALL' => 'Tout sélectionner',
	'AP_POLL_MANAGE_CLOSE' => 'Fermer',
	'AP_POLL_MANAGE_OPEN' => 'Ouvrir',
	'AP_POLL_LIST_ALL' => 'Tous les sondages',
	'AP_POLL_LIST_OPEN' => 'Ouverts',
	'AP_POLL_LIST_CLOSED' => 'Fermés',
	'AP_POLL_LIST_EMPTY' => 'Aucun sondage accessible n’a été trouvé.',
	'AP_POLL_LIST_VIEW' => 'Voir le sondage',
	'AP_POLL_LIST_ENDS' => 'Se termine le %s',
	'AP_POLL_LIST_ENDED' => 'Terminé le %s',
	'AP_POLL_LIST_LEADING' => 'Résultat en tête : %1$s - %2$s',
	'AP_POLL_LIST_WINNER' => 'Vainqueur : %1$s - %2$s',
// Posting
	...
	'AP_SCORE_RESULT' => 'Résultat de la notation',
	'AP_SCORE_RESULT_EXPLAIN' => 'Affiche les points cumulés ou la moyenne arithmétique des évaluations attribuées à chaque option.',
	'AP_SCORE_RESULT_TOTAL' => 'Points cumulés',
	'AP_SCORE_RESULT_AVERAGE' => 'Évaluation moyenne',
	'AP_POLL_SHOW_PERCENT' => 'Afficher le pourcentage',
	'AP_POLL_SHOW_PERCENT_EXPLAIN' => 'Affiche le pourcentage à côté de chaque barre. En mode moyenne, la barre est toujours dimensionnée par rapport à l’évaluation maximale.',
	...
	'AP_POLL_START'                => 'Début du sondage',
	'AP_POLL_START_EXPLAIN'        => 'Laissez ce champ vide pour rendre le sondage disponible immédiatement. Jusqu’à cette date et cette heure, le sujet reste visible mais le sondage est masqué.',
	'AP_POLL_START_INVALID'        => 'Le début du sondage doit être une date et une heure futures valides',
	...
	'AP_APPEND_OPTIONS' => 'Ajouter des options sans réinitialiser les votes',
	'AP_APPEND_OPTIONS_EXPLAIN' => 'Conserve tous les votes existants et ajoute uniquement les nouvelles options à la fin de la liste d’options d’une question.',
	'AP_APPEND_OPTIONS_WARNING' => 'Les questions et options existantes ne doivent pas être renommées, supprimées ou réordonnées. La modification du vote doit être autorisée. Les votants inscrits précédents qui y ont droit seront avertis selon le réglage du PCA et leurs préférences de notification.',
	'AP_APPEND_INVALID' => 'Il est impossible d’ajouter des options à ce sondage en toute sécurité.',
	'AP_APPEND_REQUIRES_CHANGES' => 'Autorisez la modification du vote avant d’ajouter des options sans réinitialiser les votes existants.',
	'AP_APPEND_POLL_ENDED' => 'Après la fin du sondage, il est impossible d’ajouter des options sans réinitialiser les votes.',
	'AP_APPEND_STRUCTURE_CHANGED' => 'Des questions ou options existantes ont été modifiées. Restaurez la définition d’origine et ajoutez les nouvelles options uniquement à la fin.',
	'AP_APPEND_TOO_MANY' => 'Les options ajoutées dépassent le nombre maximal d’options de sondage configuré.',
	'AP_APPEND_NONE' => 'Aucune nouvelle option de sondage n’a été ajoutée.',
