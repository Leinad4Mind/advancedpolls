...
// Viewtopic
	...
	'AP_SCORE_POINTS_TOTAL'       => [1 => '%d punt', 2 => '%d punten'],
	'AP_SCORE_BREAKDOWN'          => 'Stemverdeling',
	'AP_SCORE_AVERAGE'            => 'Gemiddelde: %1$s / %2$d',
	'AP_SCORE_RATINGS'            => [1 => '%d beoordeling', 2 => '%d beoordelingen'],
	'AP_SCORE_OVERALL_AVERAGE'    => 'Algemeen gemiddelde',
	...
	'AP_POLL_LIST'         => 'Peilingen',
	'AP_POLL_MANAGE_SELECT'     => 'Peiling selecteren',
	'AP_POLL_MANAGE_SELECT_ALL' => 'Alles selecteren',
	'AP_POLL_MANAGE_CLOSE'      => 'Sluiten',
	'AP_POLL_MANAGE_OPEN'       => 'Openen',
	'AP_POLL_LIST_ALL'     => 'Alle peilingen',
	'AP_POLL_LIST_OPEN'    => 'Open',
	'AP_POLL_LIST_CLOSED'  => 'Gesloten',
	'AP_POLL_LIST_EMPTY'   => 'Er zijn geen toegankelijke peilingen gevonden.',
	'AP_POLL_LIST_VIEW'    => 'Peiling bekijken',
	'AP_POLL_LIST_ENDS'    => 'Eindigt op %s',
	'AP_POLL_LIST_ENDED'   => 'Geëindigd op %s',
	'AP_POLL_LIST_LEADING' => 'Leidend resultaat: %1$s - %2$s',
	'AP_POLL_LIST_WINNER'  => 'Winnaar: %1$s - %2$s',
// Posting
	...
	'AP_SCORE_RESULT'              => 'Scoreweergave',
	'AP_SCORE_RESULT_EXPLAIN'      => 'Toont de opgetelde punten of het rekenkundige gemiddelde van de beoordelingen voor elke optie.',
	'AP_SCORE_RESULT_TOTAL'        => 'Opgetelde punten',
	'AP_SCORE_RESULT_AVERAGE'      => 'Gemiddelde beoordeling',
	'AP_POLL_SHOW_PERCENT'         => 'Percentage tonen',
	'AP_POLL_SHOW_PERCENT_EXPLAIN' => 'Toont het percentage naast elke resultaatbalk. In de gemiddelde modus wordt de balk altijd geschaald ten opzichte van de maximale beoordeling.',
	...
	'AP_POLL_START'                => 'Start van de peiling',
	'AP_POLL_START_EXPLAIN'        => 'Laat dit leeg om de peiling direct beschikbaar te maken. Tot deze datum en tijd blijft het onderwerp zichtbaar, maar is de peiling verborgen.',
	'AP_POLL_START_INVALID'        => 'De start van de peiling moet een geldige datum en tijd in de toekomst zijn',
	...
	'AP_APPEND_OPTIONS'                    => 'Opties toevoegen zonder stemmen opnieuw in te stellen',
	'AP_APPEND_OPTIONS_EXPLAIN'            => 'Behoudt alle bestaande stemmen en voegt alleen nieuwe opties toe aan het einde van de optielijst van een vraag.',
	'AP_APPEND_OPTIONS_WARNING'            => 'Bestaande vragen en opties mogen niet worden hernoemd, verwijderd of opnieuw gerangschikt. Stemwijzigingen moeten zijn toegestaan. Gerechtigde geregistreerde stemmers worden gemeld volgens de ACP-instelling en hun meldingsvoorkeuren.',
	'AP_APPEND_INVALID'                    => 'Er kunnen niet veilig opties aan deze peiling worden toegevoegd.',
	'AP_APPEND_REQUIRES_CHANGES'           => 'Sta stemwijzigingen toe voordat u opties toevoegt zonder bestaande stemmen opnieuw in te stellen.',
	'AP_APPEND_POLL_ENDED'                 => 'Na afloop van de peiling kunnen geen opties worden toegevoegd zonder de stemmen opnieuw in te stellen.',
	'AP_APPEND_STRUCTURE_CHANGED'          => 'Bestaande vragen of opties zijn gewijzigd. Herstel de oorspronkelijke definitie en voeg nieuwe opties alleen aan het einde toe.',
	'AP_APPEND_TOO_MANY'                   => 'De toegevoegde opties overschrijden het ingestelde maximumaantal peilingopties.',
	'AP_APPEND_NONE'                       => 'Er zijn geen nieuwe peilingopties toegevoegd.',
