...
// Viewtopic
	...
	'AP_SCORE_AVERAGE'   => 'Average: %1$s / %2$d',
	'AP_SCORE_RATINGS'   => [
		1 => '%d rating',
		2 => '%d ratings',
	],
	'AP_SCORE_OVERALL_AVERAGE'    => 'Overall average',
	...
	'AP_POLL_LIST'         => 'Polls',
	'AP_POLL_MANAGE_SELECT'     => 'Select poll',
	'AP_POLL_MANAGE_SELECT_ALL' => 'Select all',
	'AP_POLL_MANAGE_CLOSE'      => 'Close',
	'AP_POLL_MANAGE_OPEN'       => 'Open',
	'AP_POLL_LIST_ALL'     => 'All polls',
	'AP_POLL_LIST_OPEN'    => 'Open',
	'AP_POLL_LIST_CLOSED'  => 'Closed',
	'AP_POLL_LIST_EMPTY'   => 'No accessible polls were found.',
	'AP_POLL_LIST_VIEW'    => 'View poll',
	'AP_POLL_LIST_ENDS'    => 'Ends %s',
	'AP_POLL_LIST_ENDED'   => 'Ended %s',
	'AP_POLL_LIST_LEADING' => 'Leading result: %1$s - %2$s',
	'AP_POLL_LIST_WINNER'  => 'Winner: %1$s - %2$s',
// Posting
	...
	'AP_SCORE_RESULT'              => 'Scoring result',
	'AP_SCORE_RESULT_EXPLAIN'      => 'Display either accumulated points or the arithmetic average of the ratings submitted for each option.',
	'AP_SCORE_RESULT_TOTAL'        => 'Accumulated points',
	'AP_SCORE_RESULT_AVERAGE'      => 'Average rating',
	'AP_POLL_SHOW_PERCENT'         => 'Show percentage',
	'AP_POLL_SHOW_PERCENT_EXPLAIN' => 'Show the percentage label beside each result bar. In average mode, the bar itself is always scaled against the maximum rating.',
	...
	'AP_POLL_START'                => 'Poll start',
	'AP_POLL_START_EXPLAIN'        => 'Leave blank to make the poll available immediately. Until this date and time, the topic remains visible but the poll is hidden.',
	'AP_POLL_START_INVALID'        => 'The poll start must be a valid future date/time',
