...
$lang = array_merge($lang, array(
	...
	'AP_CLEANUP_NORMALIZE_EMPTY' => 'Normalize empty stored titles',
	'AP_CLEANUP_NORMALIZE_EMPTY_EXPLAIN' => 'Converts phpBB\'s empty &lt;t&gt;&lt;/t&gt; wrapper to an empty database value. Poll options, votes and timing fields are preserved for manual review.',
	...
	'AP_CLEANUP_CONFIRM_NORMALIZE_EMPTY' => 'Normalize %d empty stored poll title wrappers? Options, votes and timing data will not be modified.',
	...
	'AP_CLEANUP_NORMALIZE_RESULT' => '%d empty stored poll titles were normalized. Poll options, votes and timing data were preserved.',
));
