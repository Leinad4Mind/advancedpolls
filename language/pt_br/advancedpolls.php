...
// Viewtopic
	...
	'AP_SCORE_POINTS_TOTAL'       => [1 => '%d ponto', 2 => '%d pontos'],
	'AP_SCORE_BREAKDOWN'          => 'Detalhamento dos votos',
	'AP_SCORE_AVERAGE'            => 'Média: %1$s / %2$d',
	'AP_SCORE_RATINGS'            => [1 => '%d avaliação', 2 => '%d avaliações'],
	'AP_SCORE_OVERALL_AVERAGE'    => 'Média geral',
	...
	'AP_POLL_LIST'         => 'Enquetes',
	'AP_POLL_MANAGE_SELECT'     => 'Selecionar enquete',
	'AP_POLL_MANAGE_SELECT_ALL' => 'Selecionar todas',
	'AP_POLL_MANAGE_CLOSE'      => 'Encerrar',
	'AP_POLL_MANAGE_OPEN'       => 'Abrir',
	'AP_POLL_LIST_ALL'     => 'Todas as enquetes',
	'AP_POLL_LIST_OPEN'    => 'Abertas',
	'AP_POLL_LIST_CLOSED'  => 'Encerradas',
	'AP_POLL_LIST_EMPTY'   => 'Nenhuma enquete acessível foi encontrada.',
	'AP_POLL_LIST_VIEW'    => 'Ver enquete',
	'AP_POLL_LIST_ENDS'    => 'Termina em %s',
	'AP_POLL_LIST_ENDED'   => 'Terminou em %s',
	'AP_POLL_LIST_LEADING' => 'Resultado líder: %1$s - %2$s',
	'AP_POLL_LIST_WINNER'  => 'Vencedor: %1$s - %2$s',
// Posting
	...
	'AP_SCORE_RESULT'              => 'Resultado da pontuação',
	'AP_SCORE_RESULT_EXPLAIN'      => 'Exibe os pontos acumulados ou a média aritmética das avaliações enviadas para cada opção.',
	'AP_SCORE_RESULT_TOTAL'        => 'Pontos acumulados',
	'AP_SCORE_RESULT_AVERAGE'      => 'Avaliação média',
	'AP_POLL_SHOW_PERCENT'         => 'Exibir porcentagem',
	'AP_POLL_SHOW_PERCENT_EXPLAIN' => 'Exibe a porcentagem ao lado de cada barra. No modo de média, a barra é sempre dimensionada em relação à avaliação máxima.',
	...
	'AP_POLL_START'                => 'Início da votação',
	'AP_POLL_START_EXPLAIN'        => 'Deixe em branco para disponibilizar a votação imediatamente. Até essa data e hora, o tópico permanecerá visível, mas a votação ficará oculta.',
	'AP_POLL_START_INVALID'        => 'O início da votação deve ser uma data e hora futuras válidas',
	...
	'AP_APPEND_OPTIONS'                    => 'Adicionar opções sem redefinir os votos',
	'AP_APPEND_OPTIONS_EXPLAIN'            => 'Mantém todos os votos existentes e adiciona somente as novas opções ao final da lista de opções de uma pergunta.',
	'AP_APPEND_OPTIONS_WARNING'            => 'As perguntas e opções existentes não podem ser renomeadas, removidas ou reordenadas. As alterações de voto devem ser permitidas. Os usuários registrados elegíveis que já votaram serão notificados de acordo com a configuração do PCA e suas preferências de notificação.',
	'AP_APPEND_INVALID'                    => 'Não é possível adicionar opções a esta votação com segurança.',
	'AP_APPEND_REQUIRES_CHANGES'           => 'Permita alterar o voto antes de adicionar opções sem redefinir os votos existentes.',
	'AP_APPEND_POLL_ENDED'                 => 'Não é possível adicionar opções sem redefinir os votos depois que a votação terminar.',
	'AP_APPEND_STRUCTURE_CHANGED'          => 'Perguntas ou opções existentes foram alteradas. Restaure a definição original e adicione as novas opções somente ao final.',
	'AP_APPEND_TOO_MANY'                   => 'As opções adicionadas excedem o número máximo configurado de opções da votação.',
	'AP_APPEND_NONE'                       => 'Nenhuma nova opção foi adicionada à votação.',
