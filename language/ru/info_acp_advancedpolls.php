...
$lang = array_merge($lang, [
	...
	'AP_CLEANUP_ACP' => 'Очистка данных опросов',
	'LOG_AP_POLL_CLEANUP' => '<strong>Advanced Polls:</strong> Очищено %1$d строк тем с остаточными данными опросов',
	...
	'AP_ACT_POLL_START'                 => 'Включить отложенный запуск опросов',
	'AP_ACT_POLL_START_EXPLAIN'         => 'Позволяет выбрать будущие дату и время, когда опрос станет видимым и начнёт принимать голоса.',
	...
	'AP_POLL_LIST_ORDER'                 => 'Порядок вкладок опросов',
	'AP_POLL_LIST_ORDER_EXPLAIN'         => 'Определяет порядок вкладок Все, Открытые и Закрытые. Первая вкладка становится представлением по умолчанию при открытии списка опросов из панели навигации.',
