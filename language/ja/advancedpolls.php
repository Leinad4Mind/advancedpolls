...
// Viewtopic
	...
	'AP_SCORE_POINTS_TOTAL'       => [1 => '%d ポイント', 2 => '%d ポイント'],
	'AP_SCORE_BREAKDOWN'          => '得点別の投票内訳',
	'AP_SCORE_AVERAGE'            => '平均: %1$s / %2$d',
	'AP_SCORE_RATINGS'            => [1 => '%d 件の評価', 2 => '%d 件の評価'],
	'AP_SCORE_OVERALL_AVERAGE'    => '全体平均',
	...
	'AP_POLL_LIST'         => '投票',
	'AP_POLL_MANAGE_SELECT'     => '投票を選択',
	'AP_POLL_MANAGE_SELECT_ALL' => 'すべて選択',
	'AP_POLL_MANAGE_CLOSE'      => '終了',
	'AP_POLL_MANAGE_OPEN'       => '再開',
	'AP_POLL_LIST_ALL'     => 'すべての投票',
	'AP_POLL_LIST_OPEN'    => '受付中',
	'AP_POLL_LIST_CLOSED'  => '終了',
	'AP_POLL_LIST_EMPTY'   => '閲覧可能な投票は見つかりませんでした。',
	'AP_POLL_LIST_VIEW'    => '投票を表示',
	'AP_POLL_LIST_ENDS'    => '%s に終了',
	'AP_POLL_LIST_ENDED'   => '%s に終了しました',
	'AP_POLL_LIST_LEADING' => '現在の首位: %1$s - %2$s',
	'AP_POLL_LIST_WINNER'  => '勝者: %1$s - %2$s',
// Posting
	...
	'AP_SCORE_RESULT'              => '採点結果',
	'AP_SCORE_RESULT_EXPLAIN'      => '各選択肢について、累積ポイントまたは投稿された評価の算術平均を表示します。',
	'AP_SCORE_RESULT_TOTAL'        => '累積ポイント',
	'AP_SCORE_RESULT_AVERAGE'      => '平均評価',
	'AP_POLL_SHOW_PERCENT'         => '割合を表示',
	'AP_POLL_SHOW_PERCENT_EXPLAIN' => '各結果バーの横に割合を表示します。平均モードでは、バーは常に最高評価を基準に調整されます。',
	...
	'AP_POLL_START'                => '投票開始',
	'AP_POLL_START_EXPLAIN'        => '投票をすぐに利用可能にする場合は空欄にしてください。指定した日時まではトピックは表示されますが、投票は非表示になります。',
	'AP_POLL_START_INVALID'        => '投票開始には有効な未来の日時を指定してください',
	'AP_POLL_END'                  => '投票終了',
