...
// Viewtopic
	...
	'AP_POLL_VOTES_ARE_VISIBLE'      => 'Bitte beachte, falls Du abstimmst, wird Deine Stimme sichtbar sein.',
	'AP_POLL_DONT_VOTE_SHOW_RESULTS' => 'Nicht abstimmen, Ergebnis anzeigen',
	'AP_POLL_RESULTS_ARE_ORDERED'    => 'Bitte beachte, dass die Ergebnisse nach Anzahl der abgegebenen Stimmen absteigend sortiert sind.',
	'AP_POLL_TYPE_MISMATCH'          => 'Interner Fehler. Inkonsistente Abstimmungsdaten.',
	'AP_VOTE_CHANGED'                => 'Du hast nicht die Berechtigung, Deine abgegbenen Stimmen zu ändern.',
	'AP_TOO_MANY_VOTES'              => 'Du hast versucht, zuviele Stimmen abzugeben.',
	'AP_ABSTAINERS'                  => 'Haben auf eine Stimmabgabe verzichtet',
	'AP_DELETE_VOTE'                 => 'Meine Stimme löschen',

	'AP_MAX_VOTES_SELECT' => [
		1 => 'Du kannst bis zu <strong>%2$d</strong> Stimmen <strong>%1$d</strong>er Wahlmöglichkeit geben',
		2 => 'Du kannst bis zu <strong>%2$d</strong> Stimmen auf <strong>%1$d</strong> Wahlmöglichkeiten verteilen',
	],
	'AP_GUEST_VOTES' => [
	...
	'AP_POLL_MANAGE_SELECT'     => 'Umfrage auswählen',
	'AP_POLL_MANAGE_SELECT_ALL' => 'Alle auswählen',
	'AP_POLL_MANAGE_CLOSE'      => 'Schließen',
	'AP_POLL_MANAGE_OPEN'       => 'Öffnen',
	...
	'AP_POLL_LIST_WINNER'  => 'Gewinner: %1$s - %2$s',
// Posting
	...
	'AP_POLL_VOTE_MODE_EXPLAIN'    => 'Lege fest, ob Stimmen endgültig sind, schrittweise abgegeben oder während der offenen Umfrage geändert werden können.',
	...
	'AP_POLL_VOTERS_SHOW_EXPLAIN'  => 'Wenn diese Option aktiviert ist, werden Benutzer, die abgestimmt haben, für alle mit entsprechenden Berechtigungen sichtbar sein.<br />Beachte, dass diese Benutzer verborgen bleibt, falls die Abstimmungen geheim sein sollten.',
	...
	'AP_POLL_START'                => 'Umfragestart',
	'AP_POLL_START_EXPLAIN'        => 'Lass das Feld leer, damit die Umfrage sofort verfügbar ist. Bis zu diesem Datum und dieser Uhrzeit bleibt das Thema sichtbar, die Umfrage selbst jedoch verborgen.',
	'AP_POLL_START_INVALID'        => 'Der Umfragestart muss ein gültiger Zeitpunkt in der Zukunft sein',
	'AP_POLL_END'                  => 'Umfrageende',
	'AP_POLL_END_EXPLAIN'          => 'Gib das Datum und die Uhrzeit an, zu denen die Umfrage beendet sein soll. Falls eines dieser Felder ausgefüllt ist, überschreibt es die Umfragedauer. Bei leerem Datumsfeld wird das aktuelle Umfrage-Endedatum verwendet; ein leeres Zeitfeld bedeutet 00:00 Uhr. Möchtest Du wieder die Umfragedauer nutzen, musst Du diese Felder leeren.',

	'AP_YYYY_MM_DD'                 => 'YYYY-MM-DD',
	'AP_HH_MM'                      => 'HH:MM',
	'AP_POLL_END_INVALID'           => 'Ungültiges Datum/ ungültige Uhrzeit angegeben',
	'AP_POLL_TOTAL_LOWER_MAX_VOTES' => 'Die maximale Anzahl Stimmen für eine Auswahlmöglichkeit kann nicht grösser sein als die Gesamtzahl aller Stimmen für alle Wahlmöglichkeiten',
	'AP_POLL_TOTAL_LOWER_MAX_OPTS'  => 'Die maximale Anzahl aller Auswahlmöglichkeiten kann nicht größer sein als die maximale Anzahl Stimmen, die auf diese Wahlmöglichkeiten verteilt werden können',
	...
	'AP_APPEND_REQUIRES_CHANGES'           => 'Erlaube Stimmänderungen, bevor Optionen hinzugefügt werden, ohne vorhandene Stimmen zurückzusetzen.',
	'AP_APPEND_POLL_ENDED'                 => 'Nach dem Ende der Umfrage können keine Optionen hinzugefügt werden, ohne Stimmen zurückzusetzen.',
	'AP_APPEND_STRUCTURE_CHANGED'          => 'Vorhandene Fragen oder Optionen wurden geändert. Stelle die ursprüngliche Definition wieder her und füge neue Optionen nur am Ende hinzu.',
