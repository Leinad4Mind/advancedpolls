...
$lang = array_merge($lang, [
	...
	'AP_DEFAULT_SCORE_RESULT_EXPLAIN'    => 'Seleccione se as novas votações de pontuação numérica mostram inicialmente os pontos acumulados ou a média aritmética de cada opção.',
	'AP_DEFAULT_SHOW_PERCENT'            => 'Mostrar percentagens por predefinição',
	'AP_DEFAULT_SHOW_PERCENT_EXPLAIN'    => 'Visibilidade inicial da percentagem seleccionada para novas votações de pontuação numérica.',
	...
	'AP_ACT_POLL_START'                 => 'Activar início agendado das votações',
	...
	'AP_ACT_POLL_NOTIFICATIONS_EXPLAIN' => 'Activa as notificações quando os resultados de uma votação oculta se tornam visíveis e quando são adicionadas novas opções a uma votação em que um utilizador participou.',
