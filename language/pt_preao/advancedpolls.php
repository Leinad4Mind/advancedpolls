...
// Viewtopic
	...
	'AP_SCORE_RATINGS'            => [1 => '%d classificação', 2 => '%d classificações'],
	'AP_SCORE_OVERALL_AVERAGE'    => 'Média global',
	...
	'AP_RANK_SELECT_EXACTLY'     => [
		1 => 'Selecciona exactamente %d opção por ordem de preferência.',
		2 => 'Selecciona exactamente %d opções por ordem de preferência.',
	],
	'AP_POLL_LIST'         => 'Votações',
	'AP_POLL_MANAGE_SELECT'     => 'Seleccionar votação',
	'AP_POLL_MANAGE_SELECT_ALL' => 'Seleccionar todas',
	'AP_POLL_MANAGE_CLOSE'      => 'Encerrar',
	'AP_POLL_MANAGE_OPEN'       => 'Abrir',
	'AP_POLL_LIST_ALL'     => 'Todas as votações',
	'AP_POLL_LIST_OPEN'    => 'Abertas',
	'AP_POLL_LIST_CLOSED'  => 'Encerradas',
	'AP_POLL_LIST_EMPTY'   => 'Não foram encontradas votações acessíveis.',
	'AP_POLL_LIST_VIEW'    => 'Ver votação',
...
// Posting
	...
	'AP_SCORE_RESULT_EXPLAIN'      => 'Mostra os pontos acumulados ou a média aritmética das classificações atribuídas a cada opção.',
	'AP_SCORE_RESULT_TOTAL'        => 'Pontos acumulados',
	'AP_SCORE_RESULT_AVERAGE'      => 'Classificação média',
	'AP_POLL_SHOW_PERCENT'         => 'Mostrar percentagem',
	'AP_POLL_SHOW_PERCENT_EXPLAIN' => 'Mostra a percentagem junto de cada barra. No modo de média, a barra é sempre dimensionada em relação à classificação máxima.',
	...
	'AP_POLL_VOTE_MODE'            => 'Alterações do voto',
	...
	'AP_POLL_START_EXPLAIN'        => 'Deixa em branco para disponibilizar a votação imediatamente. Até esta data e hora, o tópico permanece visível, mas a votação fica oculta.',
	'AP_POLL_START_INVALID'        => 'O início da votação tem de ser uma data e hora futuras válidas',
	...
	'AP_RANK_SELECTION_INCOMPLETE'         => 'Selecciona exactamente o número configurado de opções por ordem de preferência.',
	...
	'AP_APPEND_OPTIONS_WARNING'            => 'As perguntas e opções existentes não podem ser renomeadas, removidas ou reordenadas. As alterações de voto têm de ser permitidas. Os utilizadores registados elegíveis que já votaram serão notificados de acordo com a definição do PCA e as respectivas preferências de notificação.',
	...
	'AP_POLL_MIN_VALUE_EXPLAIN'            => 'Esta é a pontuação mínima que um votante pode atribuir a uma opção seleccionada.',
